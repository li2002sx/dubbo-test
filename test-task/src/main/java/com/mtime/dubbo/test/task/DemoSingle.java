package com.mtime.dubbo.test.task;
 ...
 *
 */
public class DemoSingle implements IScheduleTaskDealSingle<Long> {

	private static transient Logger log = LoggerFactory.getLogger(DemoSingle.class);
